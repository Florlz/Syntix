export const adminStyles = Object.freeze({
    ...
    field: 'min-h-11 w-full rounded-sm border-control-border bg-surface text-foreground placeholder:text-muted focus:border-primary focus:ring-primary disabled:cursor-not-allowed disabled:bg-surface-muted disabled:text-muted',
